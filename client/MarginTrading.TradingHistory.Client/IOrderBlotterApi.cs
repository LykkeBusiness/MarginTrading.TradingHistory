...
namespace MarginTrading.TradingHistory.Client
{
    ...
    public interface IOrderBlotterApi
    {
        ...
        Task<PaginatedResponseContract<OrderForOrderBlotterContract>> Get(
            ...
            [Query, CanBeNull] List<OrderStatusContract> statuses,
            [Query, CanBeNull] List<OrderTypeContract> orderTypes,
            [Query, CanBeNull] List<OriginatorTypeContract> originatorTypes,
